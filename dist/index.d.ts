...
declare module 'pattern-flow/cyclical.d.ts' {
  {"version":3,"file":"cyclical.d.ts","sourceRoot":"","sources":["../../../home/micah/hacker-stuff/pattern-flow/src/cyclical.ts"],"names":[],"mappings":"AACA,OAAO,EAAQ,MAAM,EAAE,MAAM,aAAa,CAAA;AAS1C,eAAO,MAAM,SAAS,iFAGpB,CAAA;AAEF,eAAO,MAAM,MAAM,iFAGjB,CAAA;AAEF;;;;;;;;EAQE;AAEF,eAAO,MAAM,YAAY,iFAKvB,CAAA;AAEF,eAAO,MAAM,KAAK,yFAMhB,CAAA;;AAEF,wBAMC"}
}
...
declare module 'pattern-flow/index.d.ts' {
  {"version":3,"file":"index.d.ts","sourceRoot":"","sources":["../../../home/micah/hacker-stuff/pattern-flow/src/index.ts"],"names":[],"mappings":"AAEA,cAAc,YAAY,CAAA;AAE1B,eAAO,MAAM,UAAU,QAAS,MAAM,SAKrC,CAAA"}
}
...
declare module 'pattern-flow/quantizer.d.ts' {
  {"version":3,"file":"quantizer.d.ts","sourceRoot":"","sources":["../../../home/micah/hacker-stuff/pattern-flow/src/quantizer.ts"],"names":[],"mappings":"AAAA,OAAO,EAAE,MAAM,EAAQ,KAAK,EAAE,MAAM,aAAa,CAAA;;AAOjD,wBAMC"}
}
declare module 'pattern-flow/router' {
  //# sourceMappingURL=router.d.ts.map
}
declare module 'pattern-flow/router.d.ts' {
  {"version":3,"file":"router.d.ts","sourceRoot":"","sources":["../../../home/micah/hacker-stuff/pattern-flow/src/router.ts"],"names":[],"mappings":""}
}
declare module 'pattern-flow/spigot' {
  import { Stream } from '@most/types';
...
declare module 'pattern-flow/spigot.d.ts' {
  {"version":3,"file":"spigot.d.ts","sourceRoot":"","sources":["../../../home/micah/hacker-stuff/pattern-flow/src/spigot.ts"],"names":[],"mappings":"AACA,OAAO,EAAE,MAAM,EAAG,MAAM,aAAa,CAAA;AAMrC,UAAU,UAAU;IAClB,GAAG,EAAE,MAAM,CAAC,OAAO,CAAC,CAAA;IACpB,IAAI,CAAC,EAAE,MAAM,CAAC,OAAO,CAAC,CAAA;IACtB,EAAE,CAAC,EAAE,CAAC,CAAC,EAAE,MAAM,CAAC,GAAG,CAAC,KAAK,GAAG,CAAA;CAC7B;AAED,eAAO,MAAM,IAAI,MAAO,OAAO,GAAG,CAAC,gBAA6B,CAAA;AAChE,eAAO,MAAM,KAAK,MAAO,OAAO,GAAG,CAAC,gBAA8B,CAAA;AAElE,eAAO,MAAM,KAAK,kFAOjB,CAAA;AAsBD,eAAO,MAAM,MAAM,qEAMjB,CAAA"}
}
